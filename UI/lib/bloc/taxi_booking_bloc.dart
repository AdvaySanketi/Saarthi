...
import 'package:graviton/controllers/payment_method_controller.dart';
import 'package:graviton/controllers/taxi_booking_controller.dart';
...
import 'package:graviton/storage/taxi_booking_storage.dart';
...
class TaxiBookingBloc extends Bloc<TaxiBookingEvent, TaxiBookingState> {
  ...
  Future<void> _paymentMade(
    ...
    Saarthi saarthi = await TaxiBookingController.getSaarthi(booking);
    emit(TaxiNotConfirmedState(booking: booking, driver: saarthi));
    await Future.delayed(Duration(seconds: 1));
    emit(TaxiBookingConfirmedState(booking: booking, driver: saarthi));
  }
