...
import 'package:graviton/widgets/taxi_booking_details_widget.dart';
import 'package:graviton/widgets/taxi_booking_not_confirmed_widget.dart';
import 'package:graviton/widgets/taxi_booking_payments_widget.dart';
import 'package:graviton/widgets/taxi_booking_state_widget.dart';
import 'package:graviton/widgets/taxi_booking_taxis_widget.dart';
                            ...
                            builder: (context, currentState) {
                              switch (currentState.runtimeType) {
                                ...
                                case TaxiNotConfirmedState:
                                  var duration = const Duration(seconds: 50);
                                  sleep(duration);
