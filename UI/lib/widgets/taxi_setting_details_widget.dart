...
class TaxiSettingDetailsWidget extends StatefulWidget {
  @override
  _TaxiSettingDetailsWidgetState createState() =>
      _TaxiSettingDetailsWidgetState();
}

class _TaxiSettingDetailsWidgetState extends State<TaxiSettingDetailsWidget> {
