...
import 'package:graviton/widgets/loading_shimmer.dart';
import 'package:graviton/widgets/taxi_booking_state_widget.dart';
import 'package:graviton/widgets/taxi_setting_details_widget.dart';
import 'package:graviton/widgets/taxi_setting_not_confirmed_widget.dart';
import 'package:graviton/widgets/taxi_setting_payments_widget.dart';
import 'package:graviton/widgets/taxi_setting_taxis_widget.dart';
                            ...
                            builder: (context, currentState) {
                              switch (currentState.runtimeType) {
                                ...
                                case DetailsNotFilledState:
                                  return TaxiSettingDetailsWidget();
                                case TaxiNotSelectedState:
                                  return TaxiSettingTaxisWidget();
                                case PaymentNotInitializedState:
                                  return TaxiSettingPaymentsWidget();
                                case TaxiNotConfirmedState:
                                  var duration = const Duration(seconds: 30);
                                  sleep(duration);
                                  return TaxiSettingNotConfirmedWidget();
                                default:
                                  return Center(
