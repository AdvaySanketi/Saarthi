...
class TaxiSettingTaxisWidget extends StatefulWidget {
  @override
  _TaxiSettingTaxisWidgetState createState() => _TaxiSettingTaxisWidgetState();
}

class _TaxiSettingTaxisWidgetState extends State<TaxiSettingTaxisWidget> {
  ...
  void initState() {
    ...
    if (selectedTaxiType == null) {
      selectedTaxiType = TaxiType.Sedan;
    }
  }
      ...
      children: <Widget>[
        ...
        Row(
          ...
          children: <Widget>[
            ...
            buildIconText("₹100", Icons.monetization_on),
          ],
        ),
        SizedBox(
          height: 14.0,
